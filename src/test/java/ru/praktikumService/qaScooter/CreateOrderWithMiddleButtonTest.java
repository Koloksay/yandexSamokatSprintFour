...
public class CreateOrderWithMiddleButtonTest {
    ...
    public CreateOrderWithMiddleButtonTest(String name, String family, String address, String metro, String phoneNumber, String color, String duration) {
        this.name = name;
        this.family = family;
    ...
    public void setUp() {
        ...
        By orderButton = headPage.getOrderButtonInMiddle();
